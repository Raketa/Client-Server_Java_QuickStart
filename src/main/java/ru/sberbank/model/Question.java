...
public class Question implements Comparable<Question>{
    ...
    public Question(List<Answer> answer, String text, TestChapter testChapter) {
        this.answer = answer;
        this.text = text;
    ...
    public Question(AnswerType answerType, TestChapter testChapter, List<Answer> answer, String text, Set<Test> tests) {
